...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<ContainerPanel
			title={__('Wrapper', 'mustra-designs')}
			use={wrapperUse}
			actions={
				<OptionSelect
					aria-label={__('Width', 'mustra-designs')}
					value={wrapperWidth}
					onChange={(value) =>
						setAttributes({
		...
		>
			...
			<BaseControl
				...
				label={__('Background', 'mustra-designs')}
				inline
			>
				<ButtonGroup>
					<OptionSelect
						...
						aria-label={__('Background type', 'mustra-designs')}
						type='menu'
						noItemIcon
					/>
					...
					{backgroundType === 'solid' && (
						<ColorPicker
							...
							aria-label={__('Background color', 'mustra-designs')}
						/>
					)}
					{backgroundType === 'gradient' && (
						<>
							<OptionSelect
								...
								aria-label={__('Gradient style', 'mustra-designs')}
								noTriggerLabel
								type='menu'
							/>
							<OptionSelect
								...
								aria-label={__('Gradient angle', 'mustra-designs')}
								noTriggerLabel
								type='menu'
							/>
						</>
			...
			<OptionSelect
				...
				label={__('Rounded corners', 'mustra-designs')}
				...
				aria-label={__('Rounded corners', 'mustra-designs')}
				type='menu'
				inline
			/>
			...
			<Spacer
				...
				text={__('Spacing', 'mustra-designs')}
				border
			/>
			...
			<Responsive
				...
				label={__('Top margin', 'mustra-designs')}
			...
			<Responsive
				...
				label={__('Bottom margin', 'mustra-designs')}
				options={getOption('wrapperSpacing', attributes, manifest)}
				noModeSelect
				inline
				{...responsiveData}
			...
			<Responsive
				...
				label={__('Top padding', 'mustra-designs')}
				options={getOption('wrapperSpacing', attributes, manifest)}
				noModeSelect
				inline
				{...responsiveData}
			...
			<Responsive
				...
				label={__('Bottom padding', 'mustra-designs')}
				options={getOption('wrapperSpacing', attributes, manifest)}
				noModeSelect
				inline
				{...responsiveData}
			...
			<Responsive
				...
				label={__('Visibility', 'mustra-designs')}
