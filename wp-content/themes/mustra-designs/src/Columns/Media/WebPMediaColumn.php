 ...
 *
 * @package MustraDesigns\CustomMeta
 */

declare(strict_types=1);

namespace MustraDesigns\Columns\Media;

use MustraDesignsVendor\EightshiftLibs\Columns\Media\AbstractMediaColumns;
...
class WebPMediaColumn extends AbstractMediaColumns
{
	...
	{
		$columns[self::COLUMN_KEY] = \esc_html__('WebP', 'mustra-designs');
		return $columns;
	}
